...
import static de.l3s.icrawl.crawler.ui.InfoController.metricHierarchy;
...
public class InfoControllerTest {
    ...
    public void testMetricHierarchy() {
        ...
        assertThat(groupedCounters.keySet(), contains("", "de.l3s.icrawl.crawler.ui.InfoControllerTest", "group"));
        for (String groupName : asList("", "de.l3s.icrawl.crawler.ui.InfoControllerTest", "group")) {
