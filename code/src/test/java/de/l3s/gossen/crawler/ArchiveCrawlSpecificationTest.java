...
public class ArchiveCrawlSpecificationTest {
    ...
    public void testReadFile() throws IOException {
        ...
        assertThat(spec.getReferenceTime().getRelevance(ZonedDateTime.of(2006, 06, 15, 0, 0, 0, 0, ZoneOffset.UTC)),
            is(1.0));
    }
    ...
    public void testTimeSpecificationRoundtrip() throws Exception {
        ...
        ArchiveCrawlSpecification expected = new ArchiveCrawlSpecification("foo", new ArrayList<String>(),
            new ArrayList<String>(), referenceTime, new HashMap<Locale, DocumentVector>(),
            new HashMap<Locale, Set<String>>(), "foo-description", Locale.GERMAN, emptyMap());
